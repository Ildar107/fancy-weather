      ...
      return (
        <div className="weather-place">
          <div className="map-container">
            ...
            >
              <Marker
                latitude={this.props.markCord.latitude}
                longitude={this.props.markCord.longitude}
              >
          ...
          <div className="place-description">
            <p className="latitude">
              {t('geo.lat')}
              {' '}
              {this.props.markCord.latitude.toString().replace('.', '°')}
              &apos;
            </p>
            <p className="longitude">
              {t('geo.lng')}
              {' '}
              {this.props.markCord.longitude.toString().replace('.', '°')}
              &apos;
            </p>
          </div>
        </div>
